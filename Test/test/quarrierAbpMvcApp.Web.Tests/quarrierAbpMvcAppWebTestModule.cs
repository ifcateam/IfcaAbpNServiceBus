...
namespace quarrierAbpMvcApp
{
    [DependsOn(
        ...
        typeof(quarrierAbpMvcAppApplicationTestModule),
        typeof(AbpIdentityWebModule),
        typeof(AbpAccountWebModule),
        typeof(AbpAspNetCoreMvcUiBasicThemeModule)
    )]
    public class quarrierAbpMvcAppWebTestModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<IMvcBuilder>(builder =>
            {
                builder.PartManager.ApplicationParts.Add(new AssemblyPart(typeof(quarrierAbpMvcAppWebModule).Assembly));
            });
        }
