...
namespace IFCAnServiceBusMdl.DomainEvent.EventBus
{
    ...
    [ExposeServices(typeof(IDistributedEventBus), typeof(IfcaRabbitmqDistributedEventBus))]
    public class IfcaRabbitmqDistributedEventBus : IDistributedEventBus
    {
        public IfcaRabbitmqDistributedEventBus()
        {
        }
